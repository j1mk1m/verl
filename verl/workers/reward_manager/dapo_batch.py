...
class DAPOBatchRewardManager:
    """The DAPO reward manager with batch-style reward computation."""
    ...
    def __call__(self, data: DataProto, return_dict: bool = False):
        ...
        # Prepare batch inputs for reward computation
        ...
        if "reward_scores" in data.non_tensor_batch:
            # Reward scores are already computed when doing rollout
            results = [max(reward["user_turn_rewards"], default=0.0) for reward in data.non_tensor_batch["reward_scores"]]
        else:
        ...
        # Process results and apply overlong buffer penalties
        for i in range(len(data)):
            result = results[i]
            ...
            # Apply overlong buffer penalty if configured
            ...
            if already_print_data_sources[data_source] < self.num_examine:
                ...
                print("[response]", responses_str[i])
